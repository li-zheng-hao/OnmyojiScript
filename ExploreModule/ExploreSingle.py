...
class ExploreSingle(Fighter):
    def __init__(self):
        # 初始化
        Fighter.__init__(self)

        self.fight_boss_enable = True
        self.slide_shikigami = True
        self.slide_shikigami_progress = 20
        self.zhunbei_delay = 60

    def next_scene(self):
        '''
        移动至下一个场景，每次移动800像素
        '''
        x0 = random.randint(910, 1126)
        x1 = x0 - 800
